...
```
go get github.com/golangci/go-tools/cmd/structlayout
go get github.com/golangci/go-tools/cmd/structlayout-pretty
go get github.com/golangci/go-tools/cmd/structlayout-optimize
```
